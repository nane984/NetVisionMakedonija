 ...
 */
public class AddAditiv2 extends javax.swing.JFrame {

    private TableRowSorter<TableModel> rowSorter;
    private final Aditiv2Service aditivDb;
     ...
     * @param vrstaCemDb
     */
    public AddAditiv2(Aditiv2Service aditivDb) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "Da li zelite da dodate aditiv " + jTextFieldGradiliste.getText() + " ?");

        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            if (!jTextFieldGradiliste.getText().isEmpty()) {
                aditivDb.addNewAditiv(jTextFieldGradiliste.getText());
    ...
    private void readVrstaCementa() {
        List<Db.Aditiv2> result = aditivDb.getVrstaCementa();
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "Aditiv 2"});
