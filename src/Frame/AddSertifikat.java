 ...
 */
public class AddSertifikat extends javax.swing.JFrame {
     ...
     * @param vrstaCemDb
     */
    public AddSertifikat(SertifikatService SertifikatDb) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "Da li zelite da dodate Sertifikat " + jTextFieldGradiliste.getText() + " ?");

        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            if (!jTextFieldGradiliste.getText().isEmpty()) {
                SertifikatDb.addNewSertifikat(jTextFieldGradiliste.getText());
    ...
    private void readVrstaCementa() {
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "Sertifikat"});
