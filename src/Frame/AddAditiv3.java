 ...
 */
public class AddAditiv3 extends javax.swing.JFrame {

    private TableRowSorter<TableModel> rowSorter;
    private final Aditiv3Service aditivDb;
     ...
     * @param vrstaCemDb
     */
    public AddAditiv3(Aditiv3Service aditivDb) {
        initComponents();
    ...
    private void readVrstaCementa() {
        List<Db.Aditiv3> result = aditivDb.getVrstaCementa();
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "Aditiv 3"});
