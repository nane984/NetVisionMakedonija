 ...
 * @author brasa
 */
public class ZaglavljeChoos extends javax.swing.JFrame {

    /**
     * Creates new form ZaglavljeChoos
     */
    public ZaglavljeChoos() {
        initComponents();
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
       ...
       if (evt.getActionCommand().equals(javax.swing.JFileChooser.APPROVE_SELECTION)) {
            path.saveProp(jFileChooser1.getSelectedFile().getAbsolutePath());
            System.out.println("You chose to open this directory: "
                    + jFileChooser1.getSelectedFile().getAbsolutePath());
            Zaglavlje.loadZaglavlje();
            this.dispose();
