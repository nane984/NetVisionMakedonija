 ...
 */
public class AddKonzBetona extends javax.swing.JFrame {

    private TableRowSorter<TableModel> rowSorter;
    private final KonzbetonaService aditivDb;
    /**
     * Creates new form AddVrstaCementa
     * @param vrstaCemDb
     */
    public AddKonzBetona(KonzbetonaService aditivDb) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(320, 430, 110, 36);
        ...
        jButton2.setBounds(0, 430, 89, 36);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "Da li zelite da konz. betona" + jTextFieldGradiliste.getText() + " ?");

        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            aditivDb.addNewKonzBetona(jTextFieldGradiliste.getText());
    ...
    private void readVrstaCementa() {
         List<Db.Konzbetona> result = aditivDb.getKonzistencijaBetona();
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "Spec. betona"});
