 ...
 */
public class AddSvojstva extends javax.swing.JFrame {
     ...
     * @param vrstaCemDb
     */
    public AddSvojstva(SvojstvaService SvojstvaDb) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "Da li zelite da dodate Svojstva " + jTextFieldGradiliste.getText() + " ?");

        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            if (!jTextFieldGradiliste.getText().isEmpty()) {
                SvojstvaDb.addNewSvojstva(jTextFieldGradiliste.getText());
    ...
    private void readSvojstva() {
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "Svojstva"});
