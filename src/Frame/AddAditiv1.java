 ...
 */
public class AddAditiv1 extends javax.swing.JFrame {

    private TableRowSorter<TableModel> rowSorter;
    private final Aditiv1Service aditivDb;
     ...
     * @param vrstaCemDb
     */
    public AddAditiv1(Aditiv1Service aditivDb) {
        initComponents();
    ...
    private void readVrstaCementa() {
        List<Db.Aditiv1> result = aditivDb.getVrstaCementa();
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "Aditiv 1"});
