 ...
 */
public class AddSpecBetona extends javax.swing.JFrame {

    private TableRowSorter<TableModel> rowSorter;
    private final SpecbetonaService aditivDb;
    /**
     * Creates new form AddVrstaCementa
     * @param vrstaCemDb
     */
    public AddSpecBetona(SpecbetonaService aditivDb) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Класа на излож");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(0, 70, 210, 40);
        getContentPane().add(jTextFieldGradiliste);
        jTextFieldGradiliste.setBounds(210, 70, 220, 40);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "Da li zelite da klasa na izl." + jTextFieldGradiliste.getText() + " ?");

        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            aditivDb.addNewSpecBetona(jTextFieldGradiliste.getText());
    ...
    private void readVrstaCementa() {
         List<Db.Specbetona> result = aditivDb.getSpecBetona();
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "Klasa na izl."});
