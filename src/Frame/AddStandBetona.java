 ...
 */
public class AddStandBetona extends javax.swing.JFrame {

    private TableRowSorter<TableModel> rowSorter;
    private final StandbetonaService aditivDb;
    /**
     * Creates new form AddVrstaCementa
     * @param vrstaCemDb
     */
    public AddStandBetona(StandbetonaService aditivDb) {
        initComponents();
        URL iconURL = getClass().getResource("/image/truckBar.png");
        ImageIcon icon = new ImageIcon(iconURL);
        this.setIconImage(icon.getImage());
        this.aditivDb = aditivDb;
        readVrstaCementa();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Класа на хлорид");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(0, 70, 220, 40);
        getContentPane().add(jTextFieldGradiliste);
        jTextFieldGradiliste.setBounds(240, 70, 190, 40);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "Da li zelite da klasa na hlorid" + jTextFieldGradiliste.getText() + " ?");

        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            aditivDb.addNewStandBetona(jTextFieldGradiliste.getText());
    ...
    private void readVrstaCementa() {
         List<Db.Standbetona> result = aditivDb.getStandBetona();
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "klasa na hlorid"});
