...
import buff.*;
import filterframe.DetaljniIzvestajModified;
 ...
 */
public class AccessModified extends javax.swing.JFrame {
    ...
    public AccessModified(DefaultTableModel model, OtpremnicaService otpremnicaDB) {
        initComponents();
    ...
    private void logIn() {
        ...
        if (jPasswordField1.getPassword().length != 0) {
            ...
            if (resu.equalsIgnoreCase(result)) {
                DetaljniIzvestajModified podesavanja = new DetaljniIzvestajModified(model, otpremnicaDB);
