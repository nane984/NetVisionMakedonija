 ...
 */
public class AddVrstaCementa extends javax.swing.JFrame {

    private TableRowSorter<TableModel> rowSorter;
    private final VrstaCementaService1 vrstaCemDb;
     ...
     * @param vrstaCemDb
     */
    public AddVrstaCementa(VrstaCementaService1 vrstaCemDb) {
        initComponents();
    ...
    private void readVrstaCementa() {
        List<Db.Vrstacementa> result = vrstaCemDb.getVrstaCementa();
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "vrsta cementa"});
