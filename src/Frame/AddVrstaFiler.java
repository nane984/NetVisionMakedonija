 ...
 */
public class AddVrstaFiler extends javax.swing.JFrame {
     ...
     * @param vrstaCemDb
     */
    public AddVrstaFiler(VrstaFilerService vrstaFilerDb) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int dialogButton = JOptionPane.showConfirmDialog(null, "Da li zelite da dodate filer " + jTextFieldGradiliste.getText() + " ?");

        if (dialogButton == JOptionPane.YES_OPTION) { //The ISSUE is here
            if (!jTextFieldGradiliste.getText().isEmpty()) {
                vrstaFilerDb.addNewVrstaFilera(jTextFieldGradiliste.getText());
    ...
    private void readVrstaCementa() {
        ...
        DefaultTableModel model = new DefaultTableModel(obj, new Object[]{"r.b.", "filer"});
