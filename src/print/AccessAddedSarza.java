 ...
 */
public class AccessAddedSarza extends javax.swing.JFrame {
    ...
    public AccessAddedSarza(String brOtpreme, DetaljniIzvestaj detaljniIzvestaj, DetaljniIzvestaj1 detaljniIzvestaj1) {
        initComponents();
    ...
    private void logIn() {
        ...
        if (jPasswordField1.getPassword().length != 0) {
            ...
            if (resu.equalsIgnoreCase(result)) {
                SarzaAdded podesavanja = new SarzaAdded(brOtpreme, detaljniIzvestaj, detaljniIzvestaj1);
